...
The aiheroes-hub project at `C:\Users\Frans Jorden\Projects\aiheroes-hub` (folder was `aiheroes-internal`) has `puppeteer-core` + `@sparticuz/chromium` in its dependencies — reuse them; don't duplicate.
