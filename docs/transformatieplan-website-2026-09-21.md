...
5. **Verboden woorden en zinnen:** full-service, drie pijlers, onder één dak, alles van A tot I, stap in waar je wilt, van change management tot technische implementatie, het hele AI-traject. Ze mogen alleen nog in `company-profile.md` staan als "wat we vroeger zeiden". Eén uitzondering, besloten op 22 september: het eerste slide-label in de hero heet "Van A tot I" (Engels "From A to I"), als verkorting van de slogan. Nergens anders.
