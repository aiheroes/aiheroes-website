    ...
    <section id="standard" className="w-full py-16 md:py-24 bg-white border-y border-stone-200">
      <div className="max-w-7xl 2xl:max-w-[88rem] mx-auto px-6 lg:px-8">
        <div className="max-w-3xl mb-10 md:mb-14">
          ...
          <h2 className="text-[clamp(1.625rem,_1.125rem+1.75vw,_3.5rem)] font-serif text-brand-dark leading-tight mb-4">
            {content.title}
          </h2>
          <p className="text-base md:text-lg text-stone-600 leading-relaxed text-pretty">{content.subtitle}</p>
        </div>
