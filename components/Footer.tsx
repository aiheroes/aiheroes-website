      ...
      <div className="max-w-7xl 2xl:max-w-[88rem] mx-auto px-6 lg:px-8">
        ...
        <div className="pt-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-xs text-stone-500 gap-3">
            <div className="flex max-w-full flex-col items-center md:items-start gap-1">
              <p className="flex max-w-full flex-wrap items-center justify-center gap-x-1.5 gap-y-1 text-center md:justify-start md:text-left">
              ...
              <p className="max-w-full text-center text-[11px] text-stone-600 md:text-left">
