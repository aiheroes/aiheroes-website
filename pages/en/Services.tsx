...
export const ServicesEN: React.FC = () => {
  ...
  return (
    <PageLayout
      ...
      seoTitle="AI Services across the Netherlands: Training, Consulting & Software"
      seoDescription="Explore AI Heroes' services for organisations across the Netherlands: from AI training and consulting to custom software. All under one roof, based in Groningen."
      accentColor="red"
      ...
      <div id="contact-form" className="max-w-none py-16 md:py-24 bg-white -mx-6 md:-mx-12 px-6 md:px-12 border-t-4 border-brand-red">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <MeetingChooser
              label={CONTENT.en.contactForm.meetingLabel}
              meetings={CONTENT.en.contactForm.meetings}
              align="center"
              className="mt-3"
            />
          </div>
