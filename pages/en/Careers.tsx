...
export const CareersEN: React.FC = () => {
  const content = CONTENT.en.careersPage;
  ...
  return (
    <PageLayout
      ...
      seoDescription="Work at AI Heroes: explore our open positions and join a growing AI agency in Groningen. AI Engineer, Trainer and more."
      accentColor="blue"
    ...
    >
                  ...
                  {isExpanded && (
                    <div className="px-6 pb-6 pt-2 border-t border-stone-100 animate-fade-in-up">
                      <div className="ml-14">
                        ...
                        <h4 className="font-bold text-brand-dark mt-6 mb-3 text-sm uppercase tracking-wider">What we're looking for</h4>
                        ...
                        <h4 className="font-bold text-brand-dark mt-6 mb-3 text-sm uppercase tracking-wider">What we offer</h4>
      ...
      {/* Application Form */}
      <section id="apply" className="max-w-none py-16 md:py-20 bg-white -mx-6 md:-mx-12 px-6 md:px-12">
