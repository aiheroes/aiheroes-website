        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <section className="mb-20">
            ...
            <p className="text-stone-600 leading-relaxed mb-8 max-w-2xl">
              Ons logo vertegenwoordigt het menselijke element in AI – een gestileerde figuur met neurale paden, symbool voor de verbinding tussen menselijke en kunstmatige intelligentie.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-white p-8 border border-stone-200 flex flex-col items-center">
                ...
                <span className="text-sm text-stone-500">Primair (Kleur)</span>
              </div>
              ...
              <div className="bg-brand-dark p-8 border border-stone-200 flex flex-col items-center">
                ...
                <span className="text-sm text-white/70">Op donkere achtergrond</span>
              </div>
          ...
          <section className="mb-20">
            ...
            <p className="text-stone-600 leading-relaxed mb-8 max-w-2xl">
              Ons kleurenpalet is gedurfd maar professioneel. Het primaire rood straalt energie en actie uit, terwijl het blauw vertrouwen en technologie vertegenwoordigt.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <div className="group">
                ...
                <div className="bg-white p-4 border border-t-0 border-stone-200 rounded-b-lg">
                  <h4 className="font-bold text-brand-dark text-sm">Hero Rood</h4>
                  <p className="text-xs text-stone-500 font-mono">#D9534F</p>
                  <p className="text-xs text-stone-400 mt-1">Primair accent</p>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="bg-white p-4 border border-t-0 border-stone-200 rounded-b-lg">
                  <h4 className="font-bold text-brand-dark text-sm">Hero Blauw</h4>
                  <p className="text-xs text-stone-500 font-mono">#2563EB</p>
                  <p className="text-xs text-stone-400 mt-1">Secundair accent</p>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="bg-white p-4 border border-t-0 border-stone-200 rounded-b-lg">
                  ...
                  <p className="text-xs text-stone-400 mt-1">Tekst & achtergronden</p>
                </div>
              </div>
              ...
              <div className="group">
                ...
                <div className="bg-white p-4 border border-t-0 border-stone-200 rounded-b-lg">
                  <h4 className="font-bold text-brand-dark text-sm">Warm Wit</h4>
                  <p className="text-xs text-stone-500 font-mono">#FDFCF8</p>
                  <p className="text-xs text-stone-400 mt-1">Pagina-achtergronden</p>
                </div>
              </div>
            </div>

            {/* Extended Palette */}
            <h3 className="text-xl font-serif text-brand-dark mb-4">Uitgebreid palet</h3>
