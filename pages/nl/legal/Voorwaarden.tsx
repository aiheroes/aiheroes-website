...
export const VoorwaardenNL: React.FC = () => {
  return (
    <PageLayout
      ...
      subtitle="De spelregels voor onze samenwerking. Laatst bijgewerkt: januari 2025."
      accentColor="red"
    ...
    >
      <div className="prose prose-lg max-w-none">
        ...
        <ul className="text-stone-600 leading-relaxed mb-8 space-y-2">
          <li><strong>AI Heroes:</strong> AI Heroes B.V., gevestigd te Nederland, KvK-nummer [nummer]</li>
        ...
        <div className="bg-brand-dark text-white p-6 md:p-8">
          <h3 className="text-xl font-serif mb-3">Vragen?</h3>
