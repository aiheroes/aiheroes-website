...
export const ResourcesNL: React.FC = () => {
  const content = CONTENT.nl.resourcesPage;
  ...
  return (
    <PageLayout
      ...
      seoDescription="AI Resources: praktische kennis over AI-strategie en geletterdheid. Gratis resources om AI te begrijpen en toe te passen in je organisatie."
      accentColor="blue"
            ...
            {content.cards.map((card, i) => {
              ...
              return (
                <Link
                  key={i}
                  to={card.href}
                  className="group bg-stone-50 p-8 hover:bg-white hover:shadow-lg transition-all duration-300 border-l-4 border-brand-blue"
                >
