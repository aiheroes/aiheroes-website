...
export const TeamNL: React.FC = () => {
  return (
    <PageLayout
      lang="nl"
      title="Ons Team"
      subtitle="Geboren probleemoplossers. Vanuit Groningen, AI-hoofdstad van Europa."
      accentColor="blue"
